...
export default function BookingsReservations({
  ...
  const initial = useMemo(()=>({
    ...
    st2: { upcoming:[{ id:'r4', user:'Ken', connector:'Connector 3', date:'2025-11-01', start:'2025-11-01 08:00', end:'09:00', status:'Pending', paid:false }], past:[] }
  }), []);

  const list: Reservation[] = (initial[chargerId] as any)?.[tab] || [];
